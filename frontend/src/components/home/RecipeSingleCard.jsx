...
const RecipeSingleCard = ({ recipe }) => {
  ...
  return (
    <div className='border-2 border-black-800 rounded-lg px-4 bg-gray-100 font-sans text-xl py-2 m-4 relative hover:shadow-xl'>
      <h2 className='absolute top-1 right-1 px-4 py-1 bg-purple-300 font-semibold rounded-lg'>
        {recipe.projectID}
      </h2>

      <div className='flex justify-start items-center gap-x-2'>
        <FaIdCard className='text-green-300 text-2xl font-sans' />
      ...
      <div className='flex justify-start items-center gap-x-2'>
        <CiCircleList className='text-green-500 text-2xl' />
